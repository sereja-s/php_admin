...
trait BaseMethods
{
	...
	// Проверочный метод: пришли ли данные при помощи метода XMLHttpRequest (используется при передаче данных Ajax (асинххронной отправке запроса из браузера))
	...
	protected function redirect($http = false, $code = false)
	{
		...
		// иначе перенаправим пользоателя на главную страницу нашего сайта (обратимся к константе PATH)
